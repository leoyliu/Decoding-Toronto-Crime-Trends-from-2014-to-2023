...
* **Data Transformation:** Converting the dataset from a wide format to a long format for easier manipulation using the `tidyr` package.

* **Aggregation:** Summarizing the data by year and crime type using the `dplyr` package.
